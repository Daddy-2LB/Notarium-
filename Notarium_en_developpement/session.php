...
/*-------------------connection à la base de données--------------------------------------------------------*/
        ...
        if (isset($_GET['email']) AND $_GET['email'] == true) {
            ...
            $getid = intval($_GET['email']);
            $requser = $dbco->prepare('SELECT *  FROM nouveau_dossier WHERE email = :email');
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample10">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link disabled" href="documents_requis.php">DOCUMENTS REQUIS</a>
            </li>
            <li class="nav-item">
             <a class="nav-link" href="#">NOUVEAU CHOIX DE L'OFFICE</a>
            </li>
             <li class="nav-item">
             <a class="nav-link" href="information-du-client.php">NOUVELLE DEMANDE</a>
            </li>
            <li class="nav-item">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            ...
                            <div class="full">
                                <ul class="menu_footer">
                                    <li class="active"><a href="home.html">> Notarium.ga</a></li>
                                    <li><a href="about.html">> Notaires.ga</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-3">
