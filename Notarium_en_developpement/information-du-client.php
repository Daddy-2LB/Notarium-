...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
    ...
    <!-- contact_form -->
    <div class="font-weight: bold; dossier_succession_bila_form">
        <div class="container">
         
                <div class="information-cliente">
                    <form action="#" method="post">
                        <div class="info-client">
                            <div><input type="text" name="nom" placeholder="Votre nom" class="info" required /></div>
                            <div><input type="text" name="prenom" placeholder="votre prénom" class="info" required/></div>
                        </div>
                        <div class="info-client">
                            <div><input type="text" name="ville" placeholder="Ville" class="info" required/></div>
                            <div><input type="text" name="adresse" placeholder="Adresse" class="info" required/></div>
                        </div>
                        <div class="info-client">
                            <div><input type="text" name="phone" placeholder="Votre Numéro de téléphone" class="info" required/></div>
                            <div><input type="email" name="email" placeholder="Votre email" class="info" required/></div>
